...
public class EquipmentValueOverlay extends OverlayPanel
{
    ...
    @Inject
    private EquipmentValueOverlay(PlayerValuePlugin plugin, PlayerValueConfig config)
    {
        super(plugin);
    ...
    {
        String playerValue = plugin.getEquipmentValue();
        Color textColor = plugin.getEquipmentColor();
