...
public class InventoryValueOverlay extends OverlayPanel
{
    ...
    @Inject
    private InventoryValueOverlay(PlayerValuePlugin plugin, PlayerValueConfig config)
    {
        super(plugin);
    ...
    {
        String playerValue = plugin.getInventoryValue();
        Color textColor = plugin.getInventoryColor();
